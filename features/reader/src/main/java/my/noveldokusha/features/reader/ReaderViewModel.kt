    ...
    val state = ReaderScreenState(
        ...
        settings = ReaderScreenState.Settings(
            ...
            style = ReaderScreenState.Settings.StyleSettingsData(
                ...
                paragraphIndent = appPreferences.READER_PARAGRAPH_INDENT.state(viewModelScope),
                paragraphFirstLetterBold = appPreferences.READER_PARAGRAPH_FIRST_LETTER_BOLD.state(viewModelScope),
                sentenceSplitting = appPreferences.READER_SENTENCE_SPLITTING.state(viewModelScope),
